...
- [x] Phase 7 — web dashboard published as an Artifact, renamed "Premier League Predictor": https://claude.ai/code/artifact/9ad3c12a-43af-4c19-81fe-c091e8aad30d (`export_dashboard.py` -> `build_dashboard.py` -> republish `dashboard.html`)
  - Polish pass: week-over-week delta indicators, recent-form strip, a plain-language "how this works" intro, Attack vs Defense scatter chart, Elo ranked bar chart, an interactive scoreline probability heatmap, an explicit dark mode toggle, and team news as a proper table
